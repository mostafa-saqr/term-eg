      ...
      <span class="navbar-toggler-icon"></span>
        ...
        <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav">
                            ...
                            <div class="row g-3">
                                <div class="col-lg-2 col-12">
                                    <div class="col-megamenu">
                                        <img class="img-fluid" src="https://images.pexels.com/photos/2523921/pexels-photo-2523921.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="">
                                    </div>
                                    <!-- col-megamenu.// -->
                                </div>
                                <!-- end col-3 -->
                                ...
                                <div class="col-lg-2 col-12">
                                    <div class="col-megamenu">
                                        <img class="img-fluid" src="https://images.pexels.com/photos/274108/pexels-photo-274108.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940 " alt="">
                                    </div>
                                    <!-- col-megamenu.// -->
                                </div>
                                <!-- end col-3 -->
                                <div class="col-lg-4 col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul class="list-unstyled ms-1 mega-col-list">
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">ATV</a></li>
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">SSV</a></li>
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">UTV</a></li>
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">Pallet truck</a></li>
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">VNA</a></li>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <ul class="list-unstyled ms-1 mega-col-list">
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">Elite</a></li>
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">Ultimate</a></li>
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">Ultimate TDX</a></li>
                                                <li><img src="https://via.placeholder.com/20"><a href="/indev-filter/">Private</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="/blog-2-columns-with-frame/"> SOLUTIONS </a></li>
