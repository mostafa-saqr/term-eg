		...
		class gdlr_core_sidebar_generator{
			...
			function __construct( $sidebar_args = array() ){
				...
				$this->footer_widgets = array(
					array( 'name'=>esc_html__('Footer 1', 'realfactory'), 'id'=>'footer-1', 'description'=>esc_html__('Footer Column 1', 'realfactory') ), 
					array( 'name'=>esc_html__('Footer 2', 'realfactory'), 'id'=>'footer-2', 'description'=>esc_html__('Footer Column 2', 'realfactory') ), 
					array( 'name'=>esc_html__('Footer 3', 'realfactory'), 'id'=>'footer-3', 'description'=>esc_html__('Footer Column 3', 'realfactory') ), 
					array( 'name'=>esc_html__('Footer 4', 'realfactory'), 'id'=>'footer-4', 'description'=>esc_html__('Footer Column 4', 'realfactory') )
				);
			...
			function register_sidebar_widget(){
				...
				$sidebar_args['name'] = __('Preset', 'realfactory');
				$sidebar_args['id'] = 'gdlr-core-sidebar-preset';
				$sidebar_args['description'] = esc_html__('Another Custom widget area', 'realfactory');
				...
				foreach ( $this->sidebars as $sidebar ){
					...
					$sidebar_args['description'] = esc_html__('Custom widget area', 'realfactory');
