<?php
	...
	*/	
	...
	if( !function_exists('realfactory_gdlr_core_get_privacy_options') ){
		function realfactory_gdlr_core_get_privacy_options( $type = 1 ){
			if( function_exists('gdlr_core_get_privacy_options') ){
				return gdlr_core_get_privacy_options( $type );
			}

			return array();
		} // realfactory_gdlr_core_get_privacy_options
	}	
	...
	$realfactory_admin_option->add_element(array(
		...
		'options' => array(
			...
			'consent-settings' => array(
				'title' => esc_html__('Consent Settings', 'realfactory'),
				'options' => realfactory_gdlr_core_get_privacy_options(1)
			),
			'privacy-settings' => array(
				'title' => esc_html__('Privacy Style Settings', 'realfactory'),
				'options' => realfactory_gdlr_core_get_privacy_options(2)
			),
				...
				'options' => array(
					...
					'lightbox' => array(
						...
						'options' => array(
							...
							'lightGallery' => esc_html__('LightGallery', 'realfactory'),
			...
			'additional-script' => array(
				...
				'options' => array(
					...
					'additional-head-script2' => array(
						'title' => esc_html__('Additional Head Script ( with <script> tag )', 'realfactory'),
						'type' => 'textarea',
						'wrapper-class' => 'gdlr-core-fullsize',
						'descriptin' => esc_html__('Eg. For analytics', 'realfactory')
					),
