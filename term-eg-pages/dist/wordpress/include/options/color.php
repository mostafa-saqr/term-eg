<?php
	...
	*/	
	...
	add_filter('gdlr_core_skin_option_slug', 'realfactory_gdlr_core_skin_option_slug');
	if( !function_exists('realfactory_gdlr_core_skin_option_slug') ){
		function realfactory_gdlr_core_skin_option_slug( $option = '' ){
			return array('rftr_color', 'skin');
		}
	}

	// register skin options
	add_filter('gdlr_core_skin_options', 'realfactory_gdlr_core_skin_options');
	if( !function_exists('realfactory_gdlr_core_skin_options') ){
		function realfactory_gdlr_core_skin_options( $options = array() ){
			...
			$options = array_merge($options, array(
				...
				'title' => array(
					'title' => esc_html__('Title Color', 'realfactory'),
				...
				'title-hover' => array(
					'title' => esc_html__('Title (Link) Hover Color', 'realfactory'),
					'selector' => '#gdlr-core-skin# .gdlr-core-skin-title a:hover{ color: #gdlr# }'
				),
				'caption' => array(
					'title' => esc_html__('Caption Color', 'realfactory'),
					'selector' => '#gdlr-core-skin# .gdlr-core-skin-caption, #gdlr-core-skin# .gdlr-core-skin-caption a{ color: #gdlr# }'
				),
				'content' => array(
					'title' => esc_html__('Content Color', 'realfactory'),
					'selector' => '#gdlr-core-skin#, #gdlr-core-skin# .gdlr-core-skin-content{ color: #gdlr# }'
				),
				'icon' => array(
					'title' => esc_html__('Icon Color', 'realfactory'),
					'selector' => '#gdlr-core-skin# i, #gdlr-core-skin# .gdlr-core-skin-icon, #gdlr-core-skin# .gdlr-core-skin-icon:before, #gdlr-core-skin# .realfactory-widget ul li:before{ color: #gdlr# }'
				),
				'link' => array(
					'title' => esc_html__('Link Color', 'realfactory'),
					'selector' => '#gdlr-core-skin# a, #gdlr-core-skin# .gdlr-core-skin-link{ color: #gdlr# }'
				),
				'link-hover' => array(
					'title' => esc_html__('Link Hover Color', 'realfactory'),
					'selector' => '#gdlr-core-skin# a:hover, #gdlr-core-skin# .gdlr-core-skin-link:hover{ color: #gdlr# }'
				),
				'section-divider' => array(
					'title' => esc_html__('Divider & Elements', 'realfactory'),
					'type' => 'title'
				),
				'divider' => array(
					'title' => esc_html__('Divider Color', 'realfactory'),
				...
				'border' => array(
					'title' => esc_html__('Border Color', 'realfactory'),
				...
				'element-background' => array(
					'title' => esc_html__('Element Background Color', 'realfactory'),
					'selector' => '#gdlr-core-skin# .gdlr-core-skin-e-background{ background-color: #gdlr# }' . 
						'#gdlr-core-skin# .gdlr-core-flexslider-nav.gdlr-core-round-style li a{ background-color: #gdlr#; }' .
				...
				'element-content' => array(
					'title' => esc_html__('Element Content Color', 'realfactory'),
					'selector' => '#gdlr-core-skin# .gdlr-core-skin-e-content{ color: #gdlr# }'  . 
						'#gdlr-core-skin# .gdlr-core-flexslider-nav.gdlr-core-round-style li a i{ color: #gdlr#; }'
				),
				'section-button' => array(
					'title' => esc_html__('Button', 'realfactory'),
					'type' => 'title'
				),
				'button-text' => array(
					'title' => esc_html__('Button Text', 'realfactory'),
				...
				'button-text-hover' => array(
					'title' => esc_html__('Button Text Hover', 'realfactory'),
				...
				'button-background' => array(
					'title' => esc_html__('Button Background', 'realfactory'),
				...
				'button-background-hover' => array(
					'title' => esc_html__('Button Bg Hover / Gradient', 'realfactory'),
				...
				'button-border-color' => array(
					'title' => esc_html__('Button Border', 'realfactory'),
				...
				'button-border-hover-color' => array(
					'title' => esc_html__('Button Border Hover', 'realfactory'),
	...
	add_filter('gdlr_core_skin_css', 'realfactory_gdlr_core_skin_css', 10, 2);
	if( !function_exists('realfactory_gdlr_core_skin_css') ){
		function realfactory_gdlr_core_skin_css( $css, $skins ){
			$extra_css = '';
	...
	$realfactory_admin_option->add_element(array(
		...
		// color head section
		'title' => esc_html__('Color', 'realfactory'),
		'slug' => 'rftr_color',
		...
		'options' => array(
			...
			// starting the subnav
			'skin' => array(
				'title' => esc_html__('Skin', 'realfactory'),
				'customizer' => false,
				'options' => array(
				
					'skin' => array(
						'title' => esc_html__('Skin Settings', 'realfactory'),
						'type' => 'custom',
			...
			'header-color' => array(
				...
				'options' => array(
					...
					'page-preload-background-color' => array(
						'title' => esc_html__('Page Preload Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-page-preload{ background-color: #gdlr#; }'
					),
					'top-bar-background-color' => array(
						'title' => esc_html__('Top Bar Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#222222',
						'selector' => '.realfactory-top-bar-background{ background-color: #gdlr#; }'
					),
					'top-bar-bottom-border-color' => array(
						'title' => esc_html__('Top Bar Bottom Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body .realfactory-top-bar{ border-bottom-color: #gdlr#; }'
					),
					'top-bar-text-color' => array(
						'title' => esc_html__('Top Bar Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-top-bar{ color: #gdlr#; }'
					),
					'top-bar-link-color' => array(
						'title' => esc_html__('Top Bar Link Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body .realfactory-top-bar a{ color: #gdlr#; }'
					),
					'top-bar-link-hover-color' => array(
						'title' => esc_html__('Top Bar Link Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body .realfactory-top-bar a:hover{ color: #gdlr#; }'
					),
					'top-bar-social-color' => array(
						'title' => esc_html__('Top Bar Social Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-top-bar .realfactory-top-bar-right-social a{ color: #gdlr#; }'
					),
					'top-bar-social-hover-color' => array(
						'title' => esc_html__('Top Bar Social Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#e44444',
						'selector' => '.realfactory-top-bar .realfactory-top-bar-right-social a:hover{ color: #gdlr#; }'
					),
					'header-background-color' => array(
						'title' => esc_html__('Header Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-header-background, .realfactory-sticky-menu-placeholder, .realfactory-header-style-boxed.realfactory-fixed-navigation{ background-color: #gdlr#; }'
					),
					'header-plain-bottom-border-color' => array(
						'title' => esc_html__('Header Bottom Border Color ( Header Plain Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#e8e8e8',
						'selector' => '.realfactory-header-wrap.realfactory-header-style-plain{ border-color: #gdlr#; }'
					),
					'header-right-title-color' => array(
						'title' => esc_html__('Header Right Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#191919',
						'selector' => '.realfactory-logo-right-block .realfactory-logo-right-block-icon, .realfactory-logo-right-block .realfactory-logo-right-block-title{ color: #gdlr#; }'
					),					
					'header-right-caption-color' => array(
						'title' => esc_html__('Header Right Caption Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#929292',
						'selector' => '.realfactory-logo-right-block .realfactory-logo-right-block-caption{ color: #gdlr#; }'
					),					
					'header-right-button-text-color' => array(
						'title' => esc_html__('Header Right Button Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#1c1c1c',
						'selector' => '.realfactory-body .realfactory-header-right-button{ color: #gdlr#; }'
					),					
					'header-right-button-background-color' => array(
						'title' => esc_html__('Header Right Button Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f8c12c',
						'selector' => '.realfactory-body .realfactory-header-right-button{ background-color: #gdlr#; border-color: #gdlr#; }'
					),					
					'navigation-bar-background-color' => array(
						'title' => esc_html__('Navigation Bar Background Color ( Header Bar Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f4f4f4',
						'selector' => '.realfactory-navigation-background{ background-color: #gdlr#; }'
					),
					'navigation-slide-bar-color' => array(
						'title' => esc_html__('Navigation Slide Bar Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2d9bea',
						'selector' => '.realfactory-navigation .realfactory-navigation-slide-bar{ border-color: #gdlr#; }' . 
							'.realfactory-navigation .realfactory-navigation-slide-bar:before{ border-bottom-color: #gdlr#; }'
					),
					'logo-background-color' => array(
						'title' => esc_html__('Logo Background Color ( Header Side Menu Toggle Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-header-side-nav.realfactory-style-side-toggle .realfactory-logo{ background-color: #gdlr#; }'
					),
					'navigation-bar-right-icon-color' => array(
						'title' => esc_html__('Navigation Bar Right Icon Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#383838',
						'selector'=> '.realfactory-main-menu-search i, .realfactory-main-menu-cart i{ color: #gdlr#; }'
					),
					'woocommerce-cart-icon-number-background' => array(
						'title' => esc_html__('Woocommmerce Cart\'s Icon Number Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#bd584e',
						'selector'=> '.realfactory-main-menu-cart > .realfactory-top-cart-count{ background-color: #gdlr#; }'
					),
					'woocommerce-cart-icon-number-color' => array(
						'title' => esc_html__('Woocommmerce Cart\'s Icon Number Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector'=> '.realfactory-main-menu-cart > .realfactory-top-cart-count{ color: #gdlr#; }'
					),
					'secondary-menu-icon-color' => array(
						'title' => esc_html__('Secondary Menu Icon Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#383838',
						'selector'=> '.realfactory-top-menu-button i, .realfactory-mobile-menu-button i{ color: #gdlr#; }' . 
							'.realfactory-mobile-button-hamburger:before, ' . 
							'.realfactory-mobile-button-hamburger:after, ' . 
							'.realfactory-mobile-button-hamburger span{ background: #gdlr#; }'
					),
					'secondary-menu-border-color' => array(
						'title' => esc_html__('Secondary Menu Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#dddddd',
						'selector'=> '.realfactory-main-menu-right .realfactory-top-menu-button, .realfactory-mobile-menu .realfactory-mobile-menu-button{ border-color: #gdlr#; }'
					),
					'mobile-menu-icon-color' => array(
						'title' => esc_html__('Mobile Menu Icon Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#383838',
						'selector'=> '.realfactory-mobile-header .realfactory-mobile-menu-button i, ' . 
							'.realfactory-mobile-header .realfactory-main-menu-search i, ' . 
							'.realfactory-mobile-header .realfactory-main-menu-cart i{ color: #gdlr#; }' . 
							...
							'.realfactory-mobile-header .realfactory-mobile-button-hamburger span{ background: #gdlr#; }'
					),
					'mobile-menu-border-color' => array(
						'title' => esc_html__('Mobile Menu Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#dddddd',
						'selector'=> '.realfactory-mobile-menu .realfactory-mobile-menu-button{ border-color: #gdlr#; }'
					),
					'search-overlay-background-color' => array(
						'title' => esc_html__('Search Overlay Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#000000',
						'selector'=> '.realfactory-top-search-wrap{ background-color: #gdlr#; background-color: rgba(#gdlra#, 0.88); }'
					),
					'top-cart-background-color' => array(
						'title' => esc_html__('Top Cart Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#303030',
						'selector'=> '.realfactory-top-cart-content-wrap .realfactory-top-cart-content{ background-color: #gdlr#; }'
					),
					'top-cart-text-color' => array(
						'title' => esc_html__('Top Cart Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#b5b5b5',
						'selector'=> '.realfactory-top-cart-content-wrap .realfactory-top-cart-content span, ' .
							'.realfactory-top-cart-content-wrap .realfactory-top-cart-content span.woocommerce-Price-amount.amount{ color: #gdlr#; }'
					),
					'top-cart-view-cart-color' => array(
						'title' => esc_html__('Top Cart : View Cart Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector'=> '.realfactory-top-cart-content-wrap .realfactory-top-cart-button,' .
							'.realfactory-top-cart-content-wrap .realfactory-top-cart-button:hover{ color: #gdlr#; }'
					),
					'top-cart-checkout-color' => array(
						'title' => esc_html__('Top Cart : Checkout Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#bd584e',
						'selector'=> '.realfactory-top-cart-content-wrap .realfactory-top-cart-checkout-button, ' .
							'.realfactory-top-cart-content-wrap .realfactory-top-cart-checkout-button:hover{ color: #gdlr#; }'
					),
					'breadcrumbs-background-color' => array(
						'title' => esc_html__('Breadcrumbs ( Plugin ) Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#f3f3f3',
						'selector'=> '.realfactory-body .realfactory-breadcrumbs{ background-color: #gdlr#; }'
					),
					'breadcrumbs-text-color' => array(
						'title' => esc_html__('Breadcrumbs ( Plugin ) Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#a0a0a0',
						'selector'=> '.realfactory-body .realfactory-breadcrumbs, .realfactory-body .realfactory-breadcrumbs a span{ color: #gdlr#; }'
					),
					'breadcrumbs-text-active-color' => array(
						'title' => esc_html__('Breadcrumbs ( Plugin ) Text Active Color', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#555555',
						'selector'=> '.realfactory-body .realfactory-breadcrumbs span, .realfactory-body .realfactory-breadcrumbs a:hover span{ color: #gdlr#; }'
					),
			...
			'navigation-menu-color' => array(
				'title' => esc_html__('Menu / Navigation', 'realfactory'),
				'options' => array(

					'main-menu-text-color' => array(
						'title' => esc_html__('Main Menu Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#999999',
						'selector' => '.sf-menu > li > a, .sf-vertical > li > a{ color: #gdlr#; }'
					),
					'main-menu-text-hover-color' => array(
						'title' => esc_html__('Main Menu Text Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#333333',
					...
					'sub-menu-background-color' => array(
						'title' => esc_html__('Sub Menu Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2e2e2e',
						'selector'=> '.sf-menu > .realfactory-normal-menu li, .sf-menu > .realfactory-mega-menu > .sf-mega, ' . 
							'.sf-vertical ul.sub-menu li, ul.sf-menu > .menu-item-language li{ background-color: #gdlr#; }'
					),
					'sub-menu-text-color' => array(
						'title' => esc_html__('Sub Menu Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#bebebe',
						'selector'=> '.sf-menu > li > .sub-menu a, .sf-menu > .realfactory-mega-menu > .sf-mega a, ' . 
							'.sf-vertical ul.sub-menu li a{ color: #gdlr#; }'
					),
					'sub-menu-text-hover-color' => array(
						'title' => esc_html__('Sub Menu Text Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'sub-menu-text-hover-background-color' => array(
						'title' => esc_html__('Sub Menu Text Hover Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#393939',
						'selector'=> '.sf-menu > li > .sub-menu a:hover, ' . 
							'.sf-menu > li > .sub-menu .current-menu-item > a, ' . 
					...
					'sub-mega-menu-title-color' => array(
						'title' => esc_html__('Sub Mega Menu Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector'=> '.realfactory-navigation .sf-menu > .realfactory-mega-menu .sf-mega-section-inner > a{ color: #gdlr#; }'
					),
					'sub-mega-menu-divider-color' => array(
						'title' => esc_html__('Sub Mega Menu Divider Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#424242',
						'selector'=> '.realfactory-navigation .sf-menu > .realfactory-mega-menu .sf-mega-section{ border-color: #gdlr#; }'
					),
					'side-menu-text-color' => array(
						'title' => esc_html__('Side Menu Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#979797',
					...
					'side-menu-text-hover-color' => array(
						'title' => esc_html__('Side Menu Text Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'side-menu-background-color' => array(
						'title' => esc_html__('Side Menu Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#1f1f1f',
						'selector'=> '.mm-menu{ background-color: #gdlr#; }'
					),
					'side-menu-border-color' => array(
						'title' => esc_html__('Side Menu Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#626262',
						'selector'=> 'ul.mm-listview li{ border-color: #gdlr#; }'
					),
					'overlay-menu-background-color' => array(
						'title' => esc_html__('Overlay Menu Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#000000',
						'selector'=> '.realfactory-overlay-menu-content{ background-color: #gdlr#; background-color: rgba(#gdlra#, 0.88); }'
					),
					'overlay-menu-border-color' => array(
						'title' => esc_html__('Overlay Menu Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#424242',
						'selector'=> '.realfactory-overlay-menu-content ul.menu > li, .realfactory-overlay-menu-content ul.sub-menu ul.sub-menu{ border-color: #gdlr#; }'
					),
					'overlay-menu-text-color' => array(
						'title' => esc_html__('Overlay Menu Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector'=> '.realfactory-overlay-menu-content ul li a, .realfactory-overlay-menu-content .realfactory-overlay-menu-close{ color: #gdlr#; }'
					),
					'overlay-menu-text-hover-color' => array(
						'title' => esc_html__('Overlay Menu Text Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#a8a8a8',
						'selector'=> '.realfactory-overlay-menu-content ul li a:hover{ color: #gdlr#; }'
					),
					'anchor-bullet-background-color' => array(
						'title' => esc_html__('Anchor Bullet Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#777777',
						'selector'=> '.realfactory-bullet-anchor a:before{ background-color: #gdlr#; }'
					),
					'anchor-bullet-background-active-color' => array(
						'title' => esc_html__('Anchor Bullet Background Active', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector'=> '.realfactory-bullet-anchor a:hover, .realfactory-bullet-anchor a.current-menu-item{ border-color: #gdlr#; }' .
							'.realfactory-bullet-anchor a:hover:before, .realfactory-bullet-anchor a.current-menu-item:before{ background: #gdlr#; }'
					),
					'navigation-right-button-text-color' => array(
						'title' => esc_html__('Navigation Right Button Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#333333',
						'selector'=> '.realfactory-body .realfactory-main-menu-right-button{ color: #gdlr#; }'
					),
					'navigation-right-button-background-color' => array(
						'title' => esc_html__('Navigation Right Button Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '',
						'selector'=> '.realfactory-body .realfactory-main-menu-right-button{ background-color: #gdlr#; }'
					),
					'navigation-right-button-border-color' => array(
						'title' => esc_html__('Navigation Right Button Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#333333',
						'selector'=> '.realfactory-body .realfactory-main-menu-right-button{ border-color: #gdlr#; }'
					),
					'navigation-right-button-text-hover-color' => array(
						'title' => esc_html__('Navigation Right Button Text Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#555555',
						'selector'=> '.realfactory-body .realfactory-main-menu-right-button:hover{ color: #gdlr#; }'
					),
					'navigation-right-button-background-hover-color' => array(
						'title' => esc_html__('Navigation Right Button Background Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '',
						'selector'=> '.realfactory-body .realfactory-main-menu-right-button:hover{ background-color: #gdlr#; }'
					),
					'navigation-right-button-border-hover-color' => array(
						'title' => esc_html__('Navigation Right Button Border Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#555555',
						'selector'=> '.realfactory-body .realfactory-main-menu-right-button:hover{ border-color: #gdlr#; }'
					),
			...
			'body-color' => array(
				'title' => esc_html__('Body', 'realfactory'),
				'options' => array(
				
					'body-background-color' => array(
						'title' => esc_html__('Body Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body-outer-wrapper, body.realfactory-full .realfactory-body-wrapper{ background-color: #gdlr#; }'
					),
					'container-background-color' => array(
						'title' => esc_html__('Container Background Color ( For Boxed Layout )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => 'body.realfactory-boxed .realfactory-body-wrapper, ' .
					...
					'page-title-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-page-title-wrap .realfactory-page-title{ color: #gdlr#; }'
					),
					'page-caption-color' => array(
						'title' => esc_html__('Page Caption Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-page-title-wrap .realfactory-page-caption{ color: #gdlr#; }' .
							'.realfactory-page-title-wrap .realfactory-page-caption .woocommerce-breadcrumb, .realfactory-page-title-wrap .realfactory-page-caption .woocommerce-breadcrumb a{ color: #gdlr#; }'
					),
					'page-title-background-overlay-color' => array(
						'title' => esc_html__('Page Title Background Overlay Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#000000',
						'selector' => '.realfactory-page-title-wrap .realfactory-page-title-overlay{ background-color: #gdlr#; }'
					),				
					'body-content-color' => array(
						'title' => esc_html__('Body Content Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#9b9b9b',
						'selector' => '.realfactory-body, .realfactory-body span.wpcf7-not-valid-tip{ color: #gdlr#; }'
					),				
					'heading-color' => array(
						'title' => esc_html__('Heading Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#383838',
						'selector' => '.realfactory-body h1, .realfactory-body h2, .realfactory-body h3, ' . 
							'.realfactory-body h4, .realfactory-body h5, .realfactory-body h6{ color: #gdlr#; }' . 
							'.woocommerce table.shop_attributes th, .woocommerce table.shop_table th, ' . 
							'.single-product.woocommerce div.product .product_meta .realfactory-head{ color: #gdlr#; }'
					),				
					'link-color' => array(
						'title' => esc_html__('Link Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#545454',
						'selector' => '.realfactory-body a{ color: #gdlr#; }'
					),				
					'link-hover-color' => array(
						'title' => esc_html__('Link Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#333333',
						'selector' => '.realfactory-body a:hover{ color: #gdlr#; }'
					),
					'divider-color' => array(
						'title' => esc_html__('Divider Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#e6e6e6',
						'selector' => '.realfactory-body *{ border-color: #gdlr#; }' . 
					...
					'input-box-background-color' => array(
						'title' => esc_html__('Input Box Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body input, ' .  
							'.realfactory-body textarea{ background-color: #gdlr#; }'
					),
					'input-box-border-color' => array(
						'title' => esc_html__('Input Box Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#d7d7d7',
						'selector' => '.realfactory-body input, ' .  
							'.realfactory-body textarea{ border-color: #gdlr#; }'
					),
					'input-box-text-color' => array(
						'title' => esc_html__('Input Box Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#4e4e4e',
						'selector' => '.realfactory-body input, ' .  
							'.realfactory-body textarea{ color: #gdlr#; }'
					),
					'input-box-placeholder-color' => array(
						'title' => esc_html__('Input Box Placeholder Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#4e4e4e',
						'selector' => '.realfactory-body ::-webkit-input-placeholder{  color: #gdlr#; }' .
							'.realfactory-body ::-moz-placeholder{  color: #gdlr#; }' .
							'.realfactory-body :-ms-input-placeholder{  color: #gdlr#; }' .
							'.realfactory-body :-moz-placeholder{  color: #gdlr#; }'
					),
			...
			'404-color' => array(
				'title' => esc_html__('404 Page', 'realfactory'),
				'options' => array(		

					'404-content-background-color' => array(
						'title' => esc_html__('404 Content Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#23618e',
						'selector' => '.realfactory-not-found-wrap{ background-color: #gdlr#; }'
					),
					'404-head-color' => array(
						'title' => esc_html__('404 Head Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-not-found-wrap .realfactory-not-found-head{ color: #gdlr#; }'
					),
					'404-title-color' => array(
						'title' => esc_html__('404 Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-not-found-wrap .realfactory-not-found-title{ color: #gdlr#; }'
					),
					'404-caption-color' => array(
						'title' => esc_html__('404 Caption Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#c3e7ff',
						'selector' => '.realfactory-not-found-wrap .realfactory-not-found-caption{ color: #gdlr#; }'
					),
					'404-input-background-color' => array(
						'title' => esc_html__('404 Input Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#000000',
						'selector' => '.realfactory-not-found-wrap form.search-form input.search-field{ background-color: #gdlr#; background-color: rgba(#gdlra#, 0.4) }'
					),
					'404-input-text-color' => array(
						'title' => esc_html__('404 Input Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-not-found-wrap form.search-form input.search-field, ' . 
							'.realfactory-not-found-wrap .realfactory-top-search-submit{ color: #gdlr#; } ' . 
							'.realfactory-not-found-wrap input::-webkit-input-placeholder { color: #gdlr#; } ' . 
							'.realfactory-not-found-wrap input:-moz-placeholder{ color: #gdlr#; } ' . 
							'.realfactory-not-found-wrap input::-moz-placeholder{ color: #gdlr#; } ' . 
							'.realfactory-not-found-wrap input:-ms-input-placeholder{ color: #gdlr#; }'
					),
					'404-back-to-home-color' => array(
						'title' => esc_html__('404 Back To Home', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-not-found-wrap .realfactory-not-found-back-to-home a, .realfactory-not-found-wrap .realfactory-not-found-back-to-home a:hover{ color: #gdlr#; }'
					),
			...
			'sidebar-color' => array(
				'title' => esc_html__('Sidebar / Widget', 'realfactory'),
				'options' => array(	

					'sidebar-title-color' => array(
						'title' => esc_html__('Sidebar Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#383838',
						'selector' => '.realfactory-sidebar-area .realfactory-widget-title{ color: #gdlr#; }'
					),
					'sidebar-link-color' => array(
						'title' => esc_html__('Sidebar Link Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#484848',
						'selector' => '.realfactory-sidebar-area a{ color: #gdlr#; }' . 
					...
					'sidebar-link-hover-color' => array(
						'title' => esc_html__('Sidebar Link Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#323232',
						'selector' => '.realfactory-sidebar-area a:hover, .realfactory-sidebar-area .current-menu-item > a{ color: #gdlr#; }'
					),
					'recent-post-widget-info-icon-color' => array(
						'title' => esc_html__('Recent Post Widget Info Icon', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#9c9c9c',
						'selector' => '.gdlr-core-recent-post-widget .gdlr-core-blog-info i{ color: #gdlr#; }'
					),
					'recent-post-widget-info-link-color' => array(
						'title' => esc_html__('Recent Post Widget Info Link', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#a0a0a0',
					...
					'post-slider-widget-title-color' => array(
						'title' => esc_html__('Post Slider Widget Title', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'post-slider-widget-info-color' => array(
						'title' => esc_html__('Post Slider Widget Info', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#9c9c9c',
					...
					'search-box-text-color' => array(
						'title' => esc_html__('Search Box Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#b5b5b5',
			...
			'footer-copyright-color' => array(
				...
				'options' => array(
					...
					'footer-background-color' => array(
						'title' => esc_html__('Footer Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#202020',
						'selector' => '.realfactory-footer-wrapper{ background-color: #gdlr#; }'
					),
					'footer-title-color' => array(
						'title' => esc_html__('Footer Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-footer-wrapper .realfactory-widget-title{ color: #gdlr#; }'
					),
					'footer-content-color' => array(
						'title' => esc_html__('Footer Content Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ababab',
						'selector' => '.realfactory-footer-wrapper{ color: #gdlr#; }' . 
							'.realfactory-footer-wrapper .widget_recent_entries ul li:before, .realfactory-footer-wrapper .widget_recent_comments ul li:before, ' .
						 	'.realfactory-footer-wrapper .widget_pages ul li:before, .realfactory-footer-wrapper .widget_rss ul li:before, ' .
						 	'.realfactory-footer-wrapper .widget_archive ul li:before, .realfactory-footer-wrapper .widget_categories ul li:before, .widget_nav_menu ul li:before, ' .
						 	'.realfactory-footer-wrapper .widget_meta ul li:before{ color: #gdlr#; }'
					),
					'footer-link-color' => array(
						'title' => esc_html__('Footer Link Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-footer-wrapper a{ color: #gdlr#; }'
					),
					'footer-link-hover-color' => array(
						'title' => esc_html__('Footer Link Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-footer-wrapper a:hover{ color: #gdlr#; }'
					),
					'footer-divider-color' => array(
						'title' => esc_html__('Footer Divider Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#303030',
						'selector' => '.realfactory-footer-wrapper, .realfactory-footer-wrapper *{ border-color: #gdlr#; }'
					),
					
					'copyright-background-color' => array(
						'title' => esc_html__('Copyright Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#181818',
						'selector' => '.realfactory-copyright-wrapper{ background-color: #gdlr#; }'
					),
					'copyright-text-color' => array(
						'title' => esc_html__('Copyright Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#838383',
						'selector' => '.realfactory-copyright-wrapper{ color: #gdlr#; }'
					),
					'back-to-top-background-color' => array(
						'title' => esc_html__('Back To Top Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#dbdbdb',
						'selector' => '.realfactory-footer-back-to-top-button{ background-color: #gdlr#; }'
					),
					'back-to-top-text-color' => array(
						'title' => esc_html__('Back To Top Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#313131',
						'selector' => '.realfactory-footer-back-to-top-button{ color: #gdlr#; }'
					),
			...
			'single-blog' => array(
				'title' => esc_html__('Single Blog', 'realfactory'),
				'options' => array(		

					'single-blog-title-color' => array(
						'title' => esc_html__('Single Blog ( Main Title ) Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body .realfactory-blog-title-wrap .realfactory-single-article-title{ color: #gdlr#; }'
					),
					'single-blog-info-color' => array(
						'title' => esc_html__('Single Blog ( Main Title )  Info Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body .realfactory-blog-title-wrap .realfactory-blog-info-wrapper, .realfactory-body .realfactory-blog-title-wrap .realfactory-blog-info-wrapper a, ' . 
							'.realfactory-body .realfactory-blog-title-wrap .realfactory-blog-info-wrapper a:hover, .realfactory-body .realfactory-blog-title-wrap .realfactory-blog-info-wrapper i{ color: #gdlr#; }'
					),
					'single-blog-date-day-color' => array(
						'title' => esc_html__('Single Blog ( Main Title )  Date Day Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body .realfactory-blog-title-wrap .realfactory-single-article-date-day{ color: #gdlr#; }'
					),
					'single-blog-date-month-color' => array(
						'title' => esc_html__('Single Blog ( Main Title )  Date Month Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#b1b1b1',
						'selector' => '.realfactory-body .realfactory-blog-title-wrap .realfactory-single-article-date-month{ color: #gdlr#; }'
					),
					'single-blog-divider-color' => array(
						'title' => esc_html__('Single Blog ( Main Title ) Date Divider Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-body .realfactory-blog-title-wrap .realfactory-single-article-date-wrapper{ border-color: #gdlr#; }'
					),
					'single-blog-title-background-overlay-color' => array(
						'title' => esc_html__('Single Blog ( Main Title ) Background Overlay Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#000000',
						'selector' => '.realfactory-blog-title-wrap .realfactory-blog-title-overlay{ background-color: #gdlr#; }'
					),
					'single-blog-author-title-color' => array(
						'title' => esc_html__('Single Blog Author Title', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#464646',
						'selector' => '.realfactory-single-author .realfactory-single-author-title a, .realfactory-single-author .realfactory-single-author-title a:hover{ color: #gdlr#; }'
					),
					'single-blog-author-caption-color' => array(
						'title' => esc_html__('Single Blog Author Caption', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#b1b1b1',
						'selector' => '.realfactory-single-author .realfactory-single-author-caption{ color: #gdlr#; }'
					),
					'single-blog-navigation-color' => array(
						'title' => esc_html__('Single Blog Navigation Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#bcbcbc',
						'selector' => '.realfactory-single-nav a, .realfactory-single-nav a:hover{ color: #gdlr#; }'
					),
					'single-blog-comment-title-color' => array(
						'title' => esc_html__('Single Blog Comment Title', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#464646',
						'selector' => '.realfactory-comments-area .realfactory-comments-title, .realfactory-comments-area .comment-author, ' . 
							'.realfactory-comments-area .comment-reply-title{ color: #gdlr#; }'
					),
					'single-blog-comment-reply-color' => array(
						'title' => esc_html__('Single Comment Reply Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#bcbcbc',
						'selector' => '.realfactory-comments-area .comment-reply a, .realfactory-comments-area .comment-reply a:hover{ color: #gdlr#; }'
					),
					'single-blog-comment-time-color' => array(
						'title' => esc_html__('Single Comment Time Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#b1b1b1',
						'selector' => '.realfactory-comments-area .comment-time a, .realfactory-comments-area .comment-time a:hover{ color: #gdlr#; }'
					),
			...
			'blog-color' => array(
				'title' => esc_html__('Blog / Pagination', 'realfactory'),
				'options' => array(

					'blog-title-color' => array(
						'title' => esc_html__('Blog Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#343434',
						'selector' => '.gdlr-core-blog-title a, .realfactory-body .realfactory-single-article-title, .realfactory-body .realfactory-single-article-title a{ color: #gdlr#; }'
					),
					'blog-title-hover-color' => array(
						'title' => esc_html__('Blog Title Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#343434',
						'selector' => '.gdlr-core-blog-title a:hover, .realfactory-body .realfactory-single-article-title a:hover{ color: #gdlr#; }'
					),
					'blog-sticky-banner-color' => array(
						'title' => esc_html__('Blog Sticky Banner Text', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#444444',
						'selector' => '.gdlr-core-sticky-banner, .realfactory-sticky-banner{ color: #gdlr#; }'
					),
					'blog-sticky-banner-background' => array(
						'title' => esc_html__('Blog Sticky Banner Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f3f3f3',
						'selector' => '.gdlr-core-sticky-banner, .realfactory-sticky-banner{ background-color: #gdlr#; }'
					),
					'blog-info-color' => array(
						'title' => esc_html__('Blog Info Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#959595',
						'selector' => '.realfactory-single-article .realfactory-blog-info-wrapper, .realfactory-single-article .realfactory-blog-info-wrapper a, ' . 
					...
					'blog-info-icon-color' => array(
						'title' => esc_html__('Blog Info Icon Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f1bf37',
						'selector' => '.realfactory-single-article .realfactory-blog-info-wrapper i, .gdlr-core-blog-info-wrapper i{ color: #gdlr#; }'
					),
					'blog-date-day-color' => array(
						'title' => esc_html__('Blog Date Day Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#353535',
						'selector' => '.gdlr-core-blog-date-wrapper .gdlr-core-blog-date-day, .realfactory-single-article .realfactory-single-article-date-day{ color: #gdlr#; }'
					),
					'blog-date-month-color' => array(
						'title' => esc_html__('Blog Date Month Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#8a8a8a',
						'selector' => '.gdlr-core-blog-date-wrapper .gdlr-core-blog-date-month, .realfactory-single-article .realfactory-single-article-date-month{ color: #gdlr#; }'
					),
					'blog-date-divider-color' => array(
						'title' => esc_html__('Blog Date Divider Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f8c12c',
						'selector' => '.realfactory-body .gdlr-core-blog-date-wrapper, .realfactory-body .realfactory-single-article-date-wrapper{ border-color: #gdlr#; }'
					),
					'blog-frame-background-color' => array(
						'title' => esc_html__('Blog Frame Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f9f9f9',
					...
					'blog-modern-hover-background-color' => array(
						'title' => esc_html__('Blog Thumbnail ( Opacity ) Hover Background Color', 'realfactory'),
						'type' => 'colorpicker', 
						'default' => '#000',
						'selector' => '.gdlr-core-opacity-on-hover{ background: #gdlr#; }'
					),
					'blog-thumbnail-category-background' => array(
						'title' => esc_html__('Blog Thumbnail Category Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#343de2',
					...
					'blog-modern-text-color' => array(
						'title' => esc_html__('Blog Modern/Metro Overlay Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'blog-aside-background-color' => array(
						'title' => esc_html__('Blog Quote / Aside Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2d9bea',
						'selector' => '.realfactory-blog-aside-format .realfactory-single-article-content, ' . 
					...
					'blog-aside-text-color' => array(
						'title' => esc_html__('Blog Quote / Aside Text', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.realfactory-blog-aside-format .realfactory-single-article-content, ' . 
					...
					'pagination-background-color' => array(
						'title' => esc_html__('Pagination Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f0f0f0',
						'selector' => '.gdlr-core-pagination a{ background-color: #gdlr#; }'
					),
					'pagination-text-color' => array(
						'title' => esc_html__('Pagination Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#929292',
						'selector' => '.gdlr-core-pagination a{ color: #gdlr#; }'
					),
					'pagination-background-hover-color' => array(
						'title' => esc_html__('Pagination Background Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2f9cea',
					...
					'pagination-text-hover-color' => array(
						'title' => esc_html__('Pagination Text Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'pagination-plain-color' => array(
						'title' => esc_html__('Pagination ( Border / Plain ) Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#b4b4b4',
					...
					'pagination-plain-hover-color' => array(
						'title' => esc_html__('Pagination ( Border / Plain ) Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#424242',
			...
			'port-color' => array(
				'title' => esc_html__('Portfolio Color', 'realfactory'),
				'options' => array(
				
					'single-portfolio-nav-color' => array(
						'title' => esc_html__('Single Portfolio Navigation Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#bcbcbc',
					...
					'portfolio-frame-background-color' => array(
						'title' => esc_html__('Portfolio Frame Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'portfolio-info-color' => array(
						'title' => esc_html__('Portfolio Info Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#b1b1b1',
					...
					'portfolio-grid2-tag-background' => array(
						'title' => esc_html__('Portfolio Grid2 Tag Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#3d3ac2',
					...
					'portfolio-badge-text-color' => array(
						'title' => esc_html__('Portfolio Badge Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.gdlr-core-portfolio-badge{ color: #gdlr#; }'
					),
					'portfolio-badge-background-color' => array(
						'title' => esc_html__('Portfolio Badge Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#e24a3b',
						'selector' => '.gdlr-core-portfolio-badge{ background-color: #gdlr#; }'
					),
					'portfolio-thumbnail-title-color' => array(
						'title' => esc_html__('Portfolio Thumbnail Title/Icon Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'portfolio-thumbnail-info-color' => array(
						'title' => esc_html__('Portfolio Thumbnail Info Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#cecece',
					...
					'portfolio-text-filter-color' => array(
						'title' => esc_html__('Portfolio Filter Text Color( Text Style ) ', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#aaaaaa',
						'selector' => '.gdlr-core-filterer-wrap.gdlr-core-style-text a{ color: #gdlr#; }'
					),
					'portfolio-text-filter-active-color' => array(
						'title' => esc_html__('Portfolio Filter Text Active Color( Text Style ) ', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#747474',
					...
					'portfolio-button-filter-text-color' => array(
						'title' => esc_html__('Portfolio Filter Button Text Color ( Button Style ) ', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#838383',
						'selector' => '.gdlr-core-filterer-wrap.gdlr-core-style-button a{ color: #gdlr#; }'
					),
					'portfolio-button-filter-background-color' => array(
						'title' => esc_html__('Portfolio Filter Button Background Color ( Button Style ) ', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f1f1f1',
					...
					'portfolio-button-filter-text-active-color' => array(
						'title' => esc_html__('Portfolio Filter Button Text Active Color ( Button Style ) ', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'portfolio-button-filter-background-active-color' => array(
						'title' => esc_html__('Portfolio Filter Button Background Active Color ( Button Style ) ', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2f9cea',
			...
			'price-table-color' => array(
				...
				'options' => array(
					...
					'price-table-price-suffix-color' => array(
						'title' => esc_html__('Price Table Price Suffix', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#acacac',
						'selector' => '.gdlr-core-price-table .gdlr-core-price-suffix{ color: #gdlr#; }'
					),
					'price-table-price-button-color' => array(
						'title' => esc_html__('Price Table Button Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'price-table-button-background-color' => array(
						'title' => esc_html__('Price Table Button Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#575757',
						'selector-extra' => true,
					...
					'price-table-button-background-top-gradient-color' => array(
						'title' => esc_html__('Price Table Button Background Top Gradient', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#414141',
					),
					'price-table-list-border-color' => array(
						'title' => esc_html__('Price Table List Border', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#e5e5e5',
			...
			'element-1-color' => array(
				'title' => esc_html__('Element A,B', 'realfactory'),
				'options' => array(
				
					'accordion-normal-icon-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Icon Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#191919',
					...
					'accordion-normal-title-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#191919',
					...
					'accordion-normal-icon-background-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Icon Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f3f3f3',
					...
					'accordion-icon-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Icon Color ( Background Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#191919',
					...
					'accordion-title-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Title Color ( Background Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#191919',
					...
					'accordion-title-background-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Title Background Color ( Background Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f3f3f3',
						'selector' => '.gdlr-core-accordion-style-background-title .gdlr-core-accordion-item-title, ' . 
							'.gdlr-core-accordion-style-background-title-icon .gdlr-core-accordion-item-title, ' . 
					...
					'accordion-icon-active-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Icon Active Color ( Background Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#191919',
					...
					'accordion-title-active-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Title Text Active Color ( Background Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#191919',
					...
					'accordion-title-background-active-color' => array(
						'title' => esc_html__('Accordion / Toggle Box Title Background Active Color ( Background Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f3f3f3',
						'selector' => '.gdlr-core-accordion-style-background-title .gdlr-core-active .gdlr-core-accordion-item-title, ' . 
							'.gdlr-core-accordion-style-background-title-icon .gdlr-core-active .gdlr-core-accordion-item-title, ' . 
					...
					'audio-content-background-color' => array(
						'title' => esc_html__('Audio Content Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#afafaf',
					...
					'audio-content-progress-color' => array(
						'title' => esc_html__('Audio Content Progress Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2d9bea',
					...
					'audio-volume-background-color' => array(
						'title' => esc_html__('Audio Volume Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#afafaf',
					...
					'audio-volume-progress-color' => array(
						'title' => esc_html__('Audio Volume Progress Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#646464',
			...
			'element-2-color' => array(
				'title' => esc_html__('Element B,C,D', 'realfactory'),
				'options' => array(

					'button-text-color' => array(
						'title' => esc_html__('Button Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.gdlr-core-body .gdlr-core-load-more, .gdlr-core-body .gdlr-core-button, .realfactory-body .realfactory-button, ' .
							'.realfactory-body input[type="button"], .realfactory-body input[type="submit"]{ color: #gdlr#; }'
					),
					'button-text-hover-color' => array(
						'title' => esc_html__('Button Text Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'button-background-color' => array(
						'title' => esc_html__('Button Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2F2F2F',
						'selector' => '.gdlr-core-body .gdlr-core-load-more, .gdlr-core-body .gdlr-core-button, .realfactory-body .realfactory-button, ' .
							'.realfactory-body input[type="button"], .realfactory-body input[type="submit"]{ background-color: #gdlr#; }'
					),
					'button-background-hover-color' => array(
						'title' => esc_html__('Button Background Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2F2F2F',
						'selector' => '.gdlr-core-body .gdlr-core-load-more:hover, .gdlr-core-body .gdlr-core-button:hover{ background-color: #gdlr#; }'
					),
					'button-border-color' => array(
						'title' => esc_html__('Button Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#383838',
					...
					'button-border-hover-color' => array(
						'title' => esc_html__('Button Border Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#000000',
					...
					'button-gradient-background-color' => array(
						'title' => esc_html__('Button ( Gradient Style ) Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#309cea',
						'selector-extra' => true,
					...
					'dropdown-tab-head-text' => array(
						'title' => esc_html__('Dropdown Tab Head Text', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#252525',
			...
			'element-3-color' => array(
				'title' => esc_html__('Element F,G,I,O,P', 'realfactory'),
				'options' => array(

					'flipbox-background-color' => array(
						'title' => esc_html__('Flipbox / Feature Box Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2d9bea',
					...
					'flipbox-border-color' => array(
						'title' => esc_html__('Flipbox / Feature Box Border', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#2a80be',
						'selector' => '.gdlr-core-flipbox-item .gdlr-core-flipbox-front, ' .
							'.gdlr-core-flipbox-item .gdlr-core-flipbox-back, ' .
					...
					'flipbox-icon-color' => array(
						'title' => esc_html__('Flipbox / Feature Box Icon', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'flipbox-title-color' => array(
						'title' => esc_html__('Flipbox / Feature Box Title', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'flipbox-caption-color' => array(
						'title' => esc_html__('Flipbox / Feature Box Caption', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'flipbox-content-color' => array(
						'title' => esc_html__('Flipbox / Feature Box Content', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'gallery-overlay-title' => array(
						'title' => esc_html__('Gallery Overlay Title', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'image-overlay-background-color' => array(
						'title' => esc_html__('Image Overlay Background', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#000000',
					...
					'image-overlay-icon-color' => array(
						'title' => esc_html__('Image Overlay Icon', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'icon-list-item-icon-color' => array(
						'title' => esc_html__('Icon List Item Icon Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#222222',
						'selector' => '.gdlr-core-icon-list-item i{ color: #gdlr#; }'
					),
					'icon-list-item-icon-background-color' => array(
						'title' => esc_html__('Icon List Item Icon Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f3f3f3',
					...
					'personnel-modern-title-color' => array(
						'title' => esc_html__('Personnel Modern Title', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'personnel-modern-position-color' => array(
						'title' => esc_html__('Personnel Modern Position', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
			...
			'element-4-color' => array(
				...
				'options' => array(
					...
					'slider-outer-navigation-background-color' => array(
						'title' => esc_html__('Slider Outer Navigation Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f1f1f1',
						'selector' => '.gdlr-core-flexslider-nav.gdlr-core-round-style li a{ background-color: #gdlr#; }'
					),
					'slider-control-navigation-color' => array(
						'title' => esc_html__('Slider Bullet Active Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#8a8a8a',
					...
					'slider-control-navigation-background-color' => array(
						'title' => esc_html__('Slider Bullet Background Color ( Cylinder Style )', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#dfdfdf',
					...
					'tab-title-color' => array(
						'title' => esc_html__('Tab Title Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#8d8d8d',
						'selector' => '.gdlr-core-tab-item-title{ color: #gdlr#; }'
					),
					'tab-title-background-color' => array(
						'title' => esc_html__('Tab Title Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f7f7f7',
					...
					'tab-title-border-color' => array(
						'title' => esc_html__('Tab Title Border Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ebebeb',
					...
					'title-item-caption-color' => array(
						'title' => esc_html__('Title Item\'s Caption Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#747474',
			...
			'product-color' => array(
				'title' => esc_html__('Woocommerce', 'realfactory'),
				'options' => array(
				
					'woocommerce-theme-color' => array(
						'title' => esc_html__('Woocommerce Theme Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#bd584e',
					...
					'woocommerce-price-color' => array(
						'title' => esc_html__('Woocommerce Price Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#bd584e',
						'selector' => 'span.woocommerce-Price-amount.amount{ color: #gdlr#; }'
					),
					'woocommerce-price-linethrough-color' => array(
						'title' => esc_html__('Woocommerce Price Line Through Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#949494',
					...
					'woocommerce-button-background-hover-color' => array(
						'title' => esc_html__('Woocommerce Button Background Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#d4786e',
					...
					'woocommerce-button-text-color' => array(
						'title' => esc_html__('Woocommerce Button Text Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'woocommerce-button-text-hover-color' => array(
						'title' => esc_html__('Woocommerce Button Text Hover Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, ' .
					...
					'woocommerce-input-background-color' => array(
						'title' => esc_html__('Woocommerce Input Background Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#f3f3f3',
					...
					'view-detail-background-color' => array(
						'title' => esc_html__('Product Item View Detail Background', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#000000',
					...
					'add-to-cart-text-color' => array(
						'title' => esc_html__('Product Item Add To Cart Text', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'add-to-cart-background-color' => array(
						'title' => esc_html__('Product Item Add To Cart Background', 'realfactory'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#bd584e',
						'selector' => '.gdlr-core-product-thumbnail .added_to_cart, ' .
					...
					'widget-price-filter-bar-background-color' => array(
						'title' => esc_html__('Widget Price Filter Bar Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#e6e6e6',
					...
					'widget-price-filter-range-color' => array(
						'title' => esc_html__('Widget Price Filter Range Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#824141',
					...
					'widget-price-filter-handle-color' => array(
						'title' => esc_html__('Widget Price Filter Handle Background', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#b3564e',
